    ...
    return (
        ...
        <main class="container">
            ...
            <section class="esp">
                ...
                <h6>Basquete com cadeiras de rodas</h6>
            ...
            <section class="esp">
                ...
                As disputas individuais e em pares têm quatro rodadas. Na competição por equipes, são seis. Cada lado (atleta, par ou equipe) lança seis bolas por rodada. Vence quem faz mais pontos ao longo da partida.</p>
                <button class="botao">Saiba mais</button>
            </section>
            ...
            <section class="esp">
                ...
                <h6>Esgrima de Cadeira de Rodas</h6>
